...
const profileSchema = z.object({
    ...
    improvementDesc: z.string().max(2000).min(200).describe("Generate the improvement that we can do in this given resume. This improvementDesc should be very verbose and very detailedfull it should be 1000 characters long"),
});
